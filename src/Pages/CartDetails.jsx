...
const CartDetails = ({ items }) => {
  ...
  // Ensure items and index are valid
  if (!items || isNaN(index) || index < 0 || index >= items.length) {
    return <div className="container mt-4">Invalid item or index.</div>;
  }
    ...
    <div className="container mt-4">
      ...
      <div className="row mb-2">
        ...
        <div className="col-md-8">
          <img
            src={element?.images[0] || "https://via.placeholder.com/400x245"}
      ...
      <div className="row">
        <div className="col-md-8">
          ...
          <p>Rating & Review</p>
          {currentuser?.rest?._id === element.hostId && (
            <>
              <strong>Host:</strong> <p>{currentuser.rest.firstname} {currentuser.rest.lastname}</p>
            </>
          )}
