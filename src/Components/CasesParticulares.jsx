...
const CasesParticulares = () => {
  ...
  // Filter properties with 'CasesParticulares' category and exclude confirmed bookings
  const filterlist = properties.filter(
    (property) =>
      property.category === "CasesParticulares" &&
...
export default CasesParticulares;
